...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Nagelmodellage",
    "Paraffinbehandlung Füße",
    "Shellac Fußnägel",
    "Maniküre Erligheim",
    "Nagelpflege Erligheim",

    // Nearby Cities - Local SEO (важно!)
    "Fußpflege Bönnigheim",
    "Fußpflege Besigheim",
    "Fußpflege Sachsenheim",
    "Fußpflege Bietigheim-Bissingen",
    "Fußpflege Freudental",
    "Fußpflege Löchgau",
    "Fußpflege Kirchheim am Neckar",
    "Fußpflege Walheim",
    "Fußpflege Mundelsheim",
    "Fußpflege Gemmrigheim",
    ...
    // Problem/Solution Keywords (высокий intent)
    "Hornhautentfernung",
    "Hornhaut entfernen lassen",
    "Nagelkorrektur eingewachsene Nägel",
    "Eingewachsene Zehennägel Behandlung",
    "Hühneraugen entfernen",
    "Rissige Fersen Behandlung",
    "Trockene Füße Pflege",
    "Fußpflege bei Diabetes",
    "Druckstellen Füße",
    "Nagelpilz kosmetisch",

    // Intent Keywords (Buchung/Termin)
    "Fußpflege Termin buchen",
    "Fußpflege online Termin",
    "Fußpflege in meiner Nähe",
    "Fußpflege Termin heute",
    "Beste Fußpflege Erligheim",
    "Professionelle Fußpflege",
    "Fußpflege Preise",

    // Long-tail Keywords
    "Kosmetische Fußpflege Baden-Württemberg",
    "Fußpflege 74391",
    "Fußpflege Landkreis Ludwigsburg",
  ],
